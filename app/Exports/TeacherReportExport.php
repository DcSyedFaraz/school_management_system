    ...
    public function map($marks): array
    {
        ...
        if ($this->classId > 4) {
            return [
                ...
                number_format(($aGradeMale + $bGradeMale + $cGradeMale + $aGradeFemale + $bGradeFemale + $cGradeFemale) / ($totalPassMale + $totalPassFemale) * 100, 2),
                $dGradeMale ?: "0",
                $dGradeFemale ?: "0",
            ...
            return [
                ...
                number_format(($aGradeMale + $bGradeMale + $cGradeMale + $dGradeMale + $aGradeFemale + $bGradeFemale + $cGradeFemale + $dGradeFemale) / ($totalPassMale + $totalPassFemale) * 100, 2),
                $eGradeMale ?: "0",
                $eGradeFemale ?: "0",
                $eGradeMale + $eGradeFemale ?: "0",
                $eGradeMale ?: "0",
