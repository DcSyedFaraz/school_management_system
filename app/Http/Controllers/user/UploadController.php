        ...
        if(Session::get('loggedin')==true){
            $req->validate(
                [
                    ...
                    'hisabatiMarks'=>'required|numeric|min:0|max:50',
                    'kiswahiliMarks'=>'required|numeric|min:0|max:50',
                    'sayansiMarks'=>'required|numeric|min:0|max:50',
                    'englishMarks'=>'required|numeric|min:0|max:50',
                    'jamiiMarks'=>'required|numeric|min:0|max:50',
                    'maadiliMarks'=>'required|numeric|min:0|max:50'
                ]
            ); 
            ...
            $mark['hisabati']=$req['hisabatiMarks'];
            $mark['kiswahili']=$req['kiswahiliMarks'];
            $mark['sayansi']=$req['sayansiMarks'];
            $mark['english']=$req['englishMarks'];
            $mark['jamii']=$req['jamiiMarks'];
            $mark['maadili']=$req['maadiliMarks'];
            $mark['total']=$req['hisabatiMarks']+$req['kiswahiliMarks']+$req['sayansiMarks']+$req['englishMarks']+$req['jamiiMarks']+$req['maadiliMarks'];
            $mark['average']=number_format((($req['hisabatiMarks']+$req['kiswahiliMarks']+$req['sayansiMarks']+$req['englishMarks']+$req['jamiiMarks']+$req['maadiliMarks'])/6), 2);
