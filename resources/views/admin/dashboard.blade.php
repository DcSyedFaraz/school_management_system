    ...
    <div class="my-3 mx-4 min-h-[88vh]">
        <div class="w-full">
            <div class="my-3">
                ...
                <form action="{{ url('/admin-dashboard/filter') }}" method="post" id="filterForm">
                    @csrf
                ...
                <div class="flex justify-end">
                    <a href="{{ url('/admin-dashboard') }}"><button type="button" form="filterForm" class="mx-1 bg-green-500 hover:bg-green-600 px-2 py-1 text-white rounded-md mt-1">Onesha Upya</button></a>
        ...
        <div class="grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-3">
            <div>
                <h2 class="text-2xl font-bold mb-2 uppercase">Muhtasari wa Matokeo:</h2>
                <canvas id="myChart"></canvas>
            </div>

            <div>
                <h2 class="text-2xl font-bold mb-2 uppercase">Muhtasari wa Nafasi ya shule:</h2>
                
                <div class="h-[350px] overflow-y-auto">
                    <table class="w-full">
                        <thead>
                            <th class="border border-black p-2 uppercase">Nafasi</th>
                            <th class="border border-black p-2 uppercase">jina la shule</th>
