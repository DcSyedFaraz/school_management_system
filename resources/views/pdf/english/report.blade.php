...
<body>
    ...
    <div class="report-container">
        <div class="header">
            ...
            <h2>DISTRICT COUNCIL OF {{ $student['districtName'] ?? '_____________________' }}</h2>
            <h2>PRIMARY SCHOOL {{ $student['schoolname'] ?? '_____________________' }}</h2>
        ...
        <div class="student-info compact">
            <p><strong>NAME:</strong> {{ $student['studentName'] ?? '_________________' }}
                <span style="float: right;"><strong>CLASS:</strong> {{ $student['classname'] ?? '________' }}</span>
            </p>
            <p>
    ...
    <tbody>
        ...
        <div class="marks-summary compact">
            ...
            <p><strong>Average:</strong> {{ $subjectsTaken > 0 ? number_format($totalMarks / $subjectsTaken, 2) : '-' }}</p>
        ...
        <div class="remarks compact">
            ...
            <p><strong>Head Teacher's Remarks:</strong> _____________________________________________________________________________________</p>
            <br>
            <p>
                <span style="float: left;"><strong>Closing Date:</strong> {{ $closingDate ?? '__________' }}</span>
                <span style="display: block; text-align: right;"><strong>Opening Date:</strong> {{ $openingDate ?? '__________' }}</span>
            </p>
        </div>

        <div class="footer">
            <p><strong>Parent Name:</strong> ___________________________________________________ <strong>Date:</strong>_____________________</p>
            <p><strong>Student Name:</strong> ______________________________________________ <strong>Class:</strong>_____________________</p>
            <p><strong>Parent's Remarks:</strong> ___________________________________________________________________________________</p>
            <p>__________________________________________________________________________________________________</p>
            <p>__________________________________________________________________________________________________</p>
            <p style="text-align: right;"><strong>Parent's Signature:</strong> _____________________</p>
        </div>
