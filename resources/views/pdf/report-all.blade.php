                    ...
                    <table>
                        <thead>
                            <tr>
                                ...
                                <th class="bg-pass">WALIOFAULU</th>
                                <th class="bg-fail">WALIOFELI</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr class="bg-white">
            ...
            <tbody>
                ...
                @foreach ($marks as $mark)
                    ...
                    <tr class="{{ $i % 2 == 0 ? 'bg-gray-200' : 'bg-white' }}">
                        ...
                        <td class="small-col {{ $gradeColorMap[$overallGrade] ?? '' }}">
                            {{ $overallGrade }}
                        </td>
                        <td class="small-col">{{ $position }}</td>
                        @php $status = $mark['average'] !== null ? Grading::statusForTotal($mark['total'], $classId) : ''; @endphp
                        <td class="small-col {{ $status === 'FAULU' ? 'status-pass' : ($status === 'FELI' ? 'status-fail' : '') }}">
                            {{ $status }}</td>
                    </tr>
                    @php $i++; @endphp
                @endforeach
