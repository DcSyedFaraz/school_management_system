...
@section('content')
    ...
    <div class="p-3">
        <div class="flex justify-end">
            <form action="{{ url('/downloadTeacherDetailedReport') }}" method="post">
                @csrf
                
                <input type="hidden" name="rClass" id="rClass" value="{{ $classId }}">
                <input type="hidden" name="rExam" id="rExam" value="{{ $examId }}">
                {{-- <input type="hidden" name="rRegion" id="rRegion" value="{{ Session::get('userRegion') }}">
                <input type="hidden" name="rDistrict" id="rDistrict" value="{{ Session::get('userDistrict') }}">
                <input type="hidden" name="rWard" id="rWard" value="{{ Session::get('userWard') }}"> --}}
                <input type="hidden" name="rSchool" id="rSchool" value="{{ Session::get('userSchool') }}">
        ...
        <div class="my-3">
            ...
            <form action="{{ url('/filterTeacherDetailedReport') }}" method="post" id="filterForm">
                @csrf
                ...
                {{-- <div class="grid lg:grid-cols-3 md:grid-cols-3 grid-cols-1 gap-2 my-2">
                    <div>
            ...
            <div class="flex justify-end">
                <a href="{{ url('/dashboard/teacher-detailed-report') }}"><button type="button" form="filterForm" class="mx-1 bg-green-500 hover:bg-green-600 px-2 py-1 text-white rounded-md mt-1">Onesha Upya</button></a>
            ...
            <table class="myTable bg-white">
                <thead>
                    <tr>
                        ...
                        <th class="border border-black uppercase" colspan="3" rowspan="2">Waliosajiliwa</th>
                ...
                <tbody>
                    ...
                    @foreach ($marks as $mark)
                        ...
                        <tr>
                            ...
                            <td class="border border-black averageMarks">{{ number_format(($mark['averageMarks']/(count($avgMarks)-$maleAbsent-$femaleAbsent)), 2) }}</td>
                            <td class="border border-black">{{ assignGrade(number_format(($mark['averageMarks']/(count($avgMarks)-$maleAbsent-$femaleAbsent)), 2)/6) }}</td>
                        </tr>
                    ...
                    @if (count($marks)>0)
                        <tr class="font-bold">
                            <td class="border-y border-l border-black text-center text-white">Jumla</td>
                            ...
                            @if ($classId>4)
                                <td class="border border-black" id="passGradeMaleJumla">0</td>
                                <td class="border border-black" id="passGradeFemaleJumla">0</td>
                                <td class="border border-black" id="passGradeJumla">0</td>
                                <td class="border border-black" id="passGradePercent">0</td>
                                <td class="border border-black" id="dGradeMaleJumla">0</td>
                                <td class="border border-black" id="dGradeFemaleJumla">0</td>
                                <td class="border border-black" id="dGradeJumla">0</td>
                                <td class="border border-black" id="eGradeMaleJumla">0</td>
                                <td class="border border-black" id="eGradeFemaleJumla">0</td>
                                <td class="border border-black" id="eGradeJumla">0</td>
                                <td class="border border-black" id="failGradeMaleJumla">0</td>
                                <td class="border border-black" id="failGradeFemaleJumla">0</td>
                                <td class="border border-black" id="failGradeJumla">0</td>
                                <td class="border border-black" id="failGradePercent">0</td>
                            @else
                                <td class="border border-black" id="dGradeMaleJumla">0</td>
                                <td class="border border-black" id="dGradeFemaleJumla">0</td>
                                <td class="border border-black" id="dGradeJumla">0</td>
                            ...
                            <td class="border border-black" id="averageMarksSum">0</td>
                            <td class="border border-black" id="finalDaraja">0</td>
                        </tr>
                    @endif
                </tbody>
            </table>
