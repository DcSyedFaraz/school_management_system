...
@section('content')
    ...
    <div class="p-3">
        ...
        <div class="my-3">
            ...
            <div class="flex justify-end">
                <a href="{{ url('/dashboard/teacher-detailed-report') }}"><button type="button" form="filterForm"
                    ...
                    @foreach ($marks as $mark)
                        ...
                        <tr>
                            ...
                            <td class="border border-black averageMarks">
                                {{ number_format($mark['averageMarks'] / (count($avgMarks) - $maleAbsent - $femaleAbsent), 2) }}
                            </td>
                            <td class="border border-black">
                                {{ assignGrade(number_format($mark['averageMarks'] / (count($avgMarks) - $maleAbsent - $femaleAbsent), 2) / 6) }}
                            </td>
                        </tr>
    ...
    <script>
        $(document).ready(function() {
            ...
            if ({{ count($marks) }} > 0) {
                ...
                console.log(finalAvg, averageMarksSum, {{ count($marks) }});
                $("#averageMarksSum").text(finalAvg.toFixed(2));
